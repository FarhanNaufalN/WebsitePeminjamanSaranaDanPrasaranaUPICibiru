		...
		<div class="modal fade" id="modalAddUser" tabindex="-1" role="dialog" aria-hidden="true">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
                                                    ...
                                                    <div class="form-group">
														<label>Email</label>
														<input readonly value="<?php echo $k['email'] ?>" type="text" name="email" class="form-control" placeholder="Email ..." required="">
													</div>

                                                    <div class="form-group">
														<label>No. HP</label>
														<input readonly value="<?php echo $k['nohp'] ?>" type="text" name="nohp" class="form-control" placeholder="No HP ..." required="">
													</div>

                                                    <div class="form-group">
														<label>Username</label>
														<input readonly value="<?php echo $k['username'] ?>" type="text" name="username" class="form-control" placeholder="Email ..." required="">
													</div>

													<div class="form-group">
														<label>Password</label>
														<input readonly value="<?php echo $k['password'] ?>" type="text" name="username" class="form-control" placeholder="Email ..." required="">
													</div>

                                                    <div class="form-group">
														<label>Level</label>
														<input readonly value="<?php echo $k['level'] ?>" type="text" name="level" class="form-control" placeholder="Level ..." required="">
													</div>
								...
								if (isset($_POST['simpan'])) {
									...
									elseif (isset($_POST['ubah'])) {
										...
										// Check if the new username already exists (excluding the current user being updated)
										$checkQuery = mysqli_query($conn, "SELECT * FROM user WHERE username = '$username' AND id != '$id'");
										if (mysqli_num_rows($checkQuery) > 0) {
											// Username already exists, show an error message or take appropriate action
											echo "<script>alert('Username already exists. Please choose a different username.')</script>";
											echo "<meta http-equiv='refresh' content=0; URL=?view=datauser>";
