<?php
    ...
    $query = mysqli_query($conn,'SELECT pinjambarang.id, pinjambarang.id_barang, pinjambarang.id_user, pinjambarang.tgl_mulai, pinjambarang.tgl_selesai, pinjambarang.qty, pinjambarang.lokasi_barang, barang.nama_barang, barang.deskripsi, user.nama_lengkap from pinjambarang inner join barang on barang.id=pinjambarang.id_barang inner join user on user.id=pinjambarang.id_user');
    ...
    $pdf->SetX(10);
    $pdf->SetFont('Arial','B',12);
    $pdf->Cell(60,9,"NAMA BARANG",1,0);
    $pdf->Cell(40,9,"DESKRIPSI",1,0,"C");
    $pdf->Cell(30,9,"QTY",1,0,"C");
    $pdf->Cell(60,9,"TGL PENGEMBALIAN",1,1,"C");
    $pdf->SetFont('Arial','',12);
        
        
    $pdf->Cell(60,9,$d["nama_barang"],"LRB",0);
    $pdf->Cell(40,9,$d["deskripsi"],"RB",0,"C");
