										...
										<table class="table">											
											...
											<tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($d['pdf_file']) {
                                                        $pdfFilePath = '../user/peminjaman/barang/uploads/' . $d['pdf_file'];
											...
											<tr>
												...
												<td>
													<?php if (empty($d['dokumentasi'])): ?>
														No Picture Uploaded
													<?php else: ?>
														<img src="../user/peminjaman/barang/dokumentasi/<?php echo $d['dokumentasi'] ?>" width="400" height="200">
													<?php endif; ?>
												</td>
											</tr>
